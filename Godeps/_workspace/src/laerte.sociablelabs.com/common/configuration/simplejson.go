...
// Useful for changing single key/value in a `Json` object.
...
// without the need to do a full traversal using Get()'s.
//
...
//
// this is analogous to Get when accessing elements of
